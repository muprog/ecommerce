...
//           return [...prevData, { ...element, index: cartData.length }]
//         })
//       }
//     } else if (match) {
...
//         toast.error(
//           `We have only ${element.quantity} number of ${element.name}.`
//         )
//       }
//     }
//   }
...
//               className='buyerProductStructure-img'
//             />
//           </div>
//         </div>
//       </div>
...
//                 <strong>Brand</strong>
//               </td>
//               <td className='td1'> {props.brand}</td>
//             </tr>
//             <tr>
//               <td>
//                 <strong>Size</strong>
//               </td>
//               <td className='td1'> {props.size}</td>
//             </tr>
//             <tr>
//               <td>
//                 <strong>Price</strong>
...
//               <td className='value'>
//                 {new Date(props.element.manufacturedDate).toLocaleDateString(
//                   'en-GB',
//                   {
//                     day: '2-digit',
//                     month: '2-digit',
...
//           <button
//             onClick={(e) => handleAddToCart(e, props.element)}
//             id={props.id}
...
//           </button>
//           <button
//             onClick={() => handleAddToFavorites(props.element)}
...
export default function BuyerProductStructure(props) {
  const { cartData, setCartData, setCount, setProcessedArray, user } =
    useContext(userContext)
